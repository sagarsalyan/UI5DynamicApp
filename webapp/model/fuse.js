...
e = this, t = function () {
	...
	function l(e) {
		return function (e) {
			...
			if (e) {
				...
				return "Object" === n && e.constructor && (n = e.constructor.name), "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n ||
					/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? d(e, t) : void 0
			}
		}(e) || function () {
			throw new TypeError(
	...
	function L(e) {
		...
		if (g(e) || v(e)) r = e, t = O(e), n = j(e);
			...
			if (!_.call(e, "name")) throw new Error(function (e) {
				return "Missing ".concat(e, " property in key")
			}("name"));
			var o = e.name;
			if (r = o, _.call(e, "weight") && (i = e.weight) <= 0) throw new Error(function (e) {
	...
	function $(e, t) {
		...
		return o.setKeys(e.map(L)), o.setSources(t), o.create(), o
	}
	...
	function N() {
		for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ?
				arguments[1] : A.minMatchCharLength, n = [], r = -1, i = -1, o = 0, c = e.length; o < c; o += 1) {
			var a = e[o];
	...
	var z = function () {
			function e(n) {
				...
				if (t(this, e), this.options = {
					...
					if (b > 32) {
						for (var S = 0, _ = b % 32, w = b - _; S < w;) x(this.pattern.substr(S, 32), S), S += 32;
						if (_) {
							var L = b - 32;
							x(this.pattern.substr(L), L)
						}
					...
					this.chunks.forEach((function (t) {
						var n = t.pattern,
							...
							y = function (e, t, n) {
								...
								if (t.length > 32) throw new Error(S(32));
								for (var m, k = t.length, M = e.length, x = Math.max(0, Math.min(o, M)), b = u, _ = x, w = d > 1 || g, L = w ? Array(M) : [];
									(m = e.indexOf(t, _)) > -1;) {
									var O = P(t, {
										currentLocation: m,
										expectedLocation: x,
									...
									if (b = Math.min(O, b), _ = m + k, w)
										for (var j = 0; j < k;) L[m + j] = 1, j += 1
								}
								_ = -1;
								for (var I = [], C = 1, E = k + M, $ = 1 << k - 1, R = 0; R < k; R += 1) {
									for (var F = 0, D = E; F < D;) {
										var z = P(t, {
											errors: R,
											currentLocation: x + D,
										...
										z <= b ? F = D : E = D, D = Math.floor((E - F) / 2 + F)
									}
									E = D;
									...
									for (var J = q; J >= K; J -= 1) {
										var T = J - 1,
											U = n[e.charAt(T)];
										if (w && (L[T] = +!!U), W[J] = (W[J + 1] << 1 | 1) & U, R && (W[J] |= (I[J + 1] | I[J]) << 1 | 1 | I[J + 1]), W[J] & $ &&
											(C = P(t, {
												errors: R,
												currentLocation: T,
												expectedLocation: x,
	...
	var W = function (e) {
		...
		G = function (e) {
			...
			function i(e) {
				...
				return t(this, i), (r = n.call(this, e))._bitapSearch = new z(e, {
					location: a,
					threshold: u,
					distance: f,
					includeMatches: d,
		...
		te = function () {
			function e(n) {
				var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					...
					f = void 0 === h ? A.findAllMatches : h,
					l = r.location,
					d = void 0 === l ? A.location : l,
					v = r.threshold,
					g = void 0 === v ? A.threshold : v,
					y = r.distance,
					p = void 0 === y ? A.distance : y;
				t(this, e), this.query = null, this.options = {
					...
					threshold: g,
					distance: p
				}, this.pattern = o ? n : n.toLowerCase(), this.query = Z(this.pattern, this.options)
			}
			return r(e, [{
				key: "searchIn",
				value: function (e) {
	...
	var ie = "$and",
		...
		fe = function (e) {
			return i({}, ie, Object.keys(e).map((function (t) {
				return i({}, t, e[t])
			})))
		},
		le = function () {
			function e(n) {
				...
				t(this, e), this.options = c({}, A, {}, r), this.options.useExtendedSearch, this._keyStore = new w(this.options.keys), this.setCollection(
					n, i)
			}
			return r(e, [{
				key: "setCollection",
				...
				value: function (e) {
					...
					return de(h, {
						ignoreFieldNorm: u
					}), a && h.sort(s), y(r) && r > -1 && (h = h.slice(0, r)), ve(h, this._docs, {
						includeMatches: o,
						includeScore: c
					})
				}
	...
	function ve(e, t) {
		var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
			...
			a = [];
		return i && a.push(R), c && a.push(F), e.map((function (e) {
			var n = e.idx,
				r = {
					item: t[n],
					refIndex: n
	...
	return le.version = "6.4.1", le.createIndex = $, le.parseIndex = function (e) {
			var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
				n = t.getFn,
...
}, "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(
	t) : (e = e || self).Fuse = t();